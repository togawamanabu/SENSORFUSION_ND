...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI> pointProcessor, pcl::PointCloud<pcl::PointXYZI>::Ptr inputCloud)
{
    ...
    Eigen::Vector4f maxPoint = Eigen::Vector4f (20, 8, 1, 1);

    inputCloud = pointProcessor.FilterCloud(inputCloud, 0.3f, minPoint , maxPoint);

    //renderPointCloud(viewer, filteredCloud, "rode", Color(0,1,0));
    ...
    renderPointCloud(viewer, segmentCloud.first, "Obs", Color(.3,.3,.3));
    renderPointCloud(viewer, segmentCloud.second, "rode", Color(0,1,0));
...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
    ...
    //renderPointCloud(viewer, segmentCloud.first, "Obs", Color(1,0,0));
    //renderPointCloud(viewer, segmentCloud.second, "rode", Color(0,1,0));
